...
<template>
  ...
  <div class="header">
    <div class="search">
      ...
      <input class="music-search" type="text" placeholder="Поиск музыки..." />
    </div>

    <button class="custom-btn btn-5">
      <span><a href="loginreg.html">Войти</a></span>
    </button>
  </div>
</template>
...
.header .search {
  ...
  display: flex;
  align-items: center;
  background: rgba(236, 154, 3, 0.787);
  border-radius: 12px;
  margin-left: 16%;
}
...
.btn-5:hover {
  color: #e6e6e6;
  background: rgba(255, 203, 31, 0.853);
  box-shadow: none;
}
.btn-5:before,
.btn-5:after {
